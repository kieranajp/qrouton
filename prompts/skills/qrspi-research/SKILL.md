...
5. Write `thoughts/shared/research/R<n>-<date>-<slug>.md` using its questions pair's number and slug. Include Research Question, Summary, Findings grouped by question or subsystem, and Open Questions, plus existing research frontmatter conventions. Use inline evidence instead of a duplicate Code References catalogue.
