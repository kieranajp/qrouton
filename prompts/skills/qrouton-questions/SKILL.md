---
name: qrouton-questions
description: Internally frame the Research part of qrouton's workflow and open the research document with its approved questions. Use when the work needs investigation but its motivating symptoms, boundaries, or questions are not yet clear.
---
