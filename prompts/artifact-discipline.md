**Write the artifact as a human handoff, not an archive.**

A durable artifact serves a reader who arrives later with the code and nothing else. Keep the conclusions and the important exceptions. Keep the evidence for each. Keep any decision the work settles, and any next step that reader cannot cheaply recover. Link to research, specs and source files, and let each link carry its own content. Leave out exploration history, repeated context, file-by-file narration and raw specialist output. Prefer a short artifact with representative references and stated gaps.
