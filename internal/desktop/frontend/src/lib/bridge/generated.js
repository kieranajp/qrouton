...
export const PRESENTER_CLOSE = "github.com/kieranajp/qrouton/internal/desktop.Presenter.Close";
export const PRESENTER_NOTE = "github.com/kieranajp/qrouton/internal/desktop.Presenter.Note";
export const PRESENTER_OPEN = "github.com/kieranajp/qrouton/internal/desktop.Presenter.Open";
export const PRESENTER_SHOW = "github.com/kieranajp/qrouton/internal/desktop.Presenter.Show";
...
export const SETTINGS_CANCEL_VAULT_DOWNLOAD = "github.com/kieranajp/qrouton/internal/desktop.Settings.CancelVaultDownload";
export const SETTINGS_CLEAR_VAULT_IMPORT_SOURCES = "github.com/kieranajp/qrouton/internal/desktop.Settings.ClearVaultImportSources";
export const SETTINGS_CONFIRM_VAULT_IMPORT = "github.com/kieranajp/qrouton/internal/desktop.Settings.ConfirmVaultImport";
export const SETTINGS_DOWNLOAD_VAULT_MODEL = "github.com/kieranajp/qrouton/internal/desktop.Settings.DownloadVaultModel";
export const SETTINGS_LOAD = "github.com/kieranajp/qrouton/internal/desktop.Settings.Load";
export const SETTINGS_PREVIEW_VAULT_CORPUS = "github.com/kieranajp/qrouton/internal/desktop.Settings.PreviewVaultCorpus";
export const SETTINGS_PREVIEW_VAULT_IMPORT = "github.com/kieranajp/qrouton/internal/desktop.Settings.PreviewVaultImport";
export const SETTINGS_QUIT = "github.com/kieranajp/qrouton/internal/desktop.Settings.Quit";
export const SETTINGS_RETRY_VAULT_IMPORTS = "github.com/kieranajp/qrouton/internal/desktop.Settings.RetryVaultImports";
export const SETTINGS_RETRY_VAULT_INDEX = "github.com/kieranajp/qrouton/internal/desktop.Settings.RetryVaultIndex";
export const SETTINGS_REVALIDATE_VAULT_IMPORT_DESTINATION = "github.com/kieranajp/qrouton/internal/desktop.Settings.RevalidateVaultImportDestination";
export const SETTINGS_SAVE = "github.com/kieranajp/qrouton/internal/desktop.Settings.Save";
export const SETTINGS_SAVE_VAULT_SESSION = "github.com/kieranajp/qrouton/internal/desktop.Settings.SaveVaultSession";
export const SETTINGS_SELECT_VAULT_IMPORT_CORPUS = "github.com/kieranajp/qrouton/internal/desktop.Settings.SelectVaultImportCorpus";
export const SETTINGS_SELECT_VAULT_IMPORT_SOURCES = "github.com/kieranajp/qrouton/internal/desktop.Settings.SelectVaultImportSources";
export const SETTINGS_VAULT_CORPUS_ENTRY = "github.com/kieranajp/qrouton/internal/desktop.Settings.VaultCorpusEntry";
export const SETTINGS_VAULT_IMPORT_STATUS = "github.com/kieranajp/qrouton/internal/desktop.Settings.VaultImportStatus";
export const SETTINGS_VAULT_SESSION = "github.com/kieranajp/qrouton/internal/desktop.Settings.VaultSession";
export const SETTINGS_VAULT_SETUP = "github.com/kieranajp/qrouton/internal/desktop.Settings.VaultSetup";
...
export const WINDOWS_OPEN_DOCUMENT_LINK = "github.com/kieranajp/qrouton/internal/desktop.Windows.OpenDocumentLink";
