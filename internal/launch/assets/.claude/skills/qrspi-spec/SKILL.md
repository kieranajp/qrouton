...
4. Have a planning lead draft `thoughts/shared/specs/S<n>-<date>-<slug>.md` when the work benefits from a durable design record. Keep it near 200 lines and include desired end state, resolved decisions with rejected alternatives, scope in/out, and open questions.
